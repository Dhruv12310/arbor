# multidomaintest_v14.py — Multi-Domain PDF Retrieval Test (v14 checkpoint-1455)
# ======================================================
# Tests v14 (checkpoint-1455) TreeSearch + StructDirect across 8 categories:
...
# Compare results against multidomaintest_results.json (v13 baseline: 31/120)
# to measure v14 improvement across non-financial domains.
...
MODEL_DIR       = f"{DRIVE_DIR}/models/treesearch-v14/checkpoint-1455"
...
RESULTS_FILE    = f"{DRIVE_DIR}/multidomaintest_v14_results.json"
...
class V14Provider(LLMProvider):
    @property
    def name(self): return "treesearch-v14/checkpoint-1455"
...
print("v14 (checkpoint-1455) model ready")
"""
